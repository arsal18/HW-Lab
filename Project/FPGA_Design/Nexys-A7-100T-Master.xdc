...
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { seg_o[3] }]; #IO_L7P_T2_A26_15 Sch=cd
...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { hrs_min }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { alram_down }]; #IO_L12P_T1_MRCC_14 Sch=btnl
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { alram_up }]; #IO_L10N_T1_D15_14 Sch=btnr
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { clock_up }]; #IO_L4N_T0_D05_14 Sch=btnu
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { clock_down }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
